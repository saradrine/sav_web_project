...
const Card = ({icon,statistic, title, padding}) => {
    return (
        <div className=" bg-white px-5 py-3.5 rounded-2xl shadow-custom-sm">
            <div className="flex items-center gap-5">
                <div
                    className={`w-12 h-12 p-2.5   ${padding ? "ps-3 pe-2" : ""} bg-custom-green rounded-full flex items-center justify-center shadow-custom-md`}>
